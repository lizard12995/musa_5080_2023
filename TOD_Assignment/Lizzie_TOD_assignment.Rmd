...
```{r}
download.file(url = "https://www.bart.gov/sites/default/files/docs/BART_System_2020.kmz_.zip"
               , destfile = "BART_lines.zip")

unzip( "BART_lines.zip")
unzip("BART_System_2020.kmz")

BART_stops <- st_read("doc.kml")
```
